...
export class VehicleBrandSelectionComponent {
  carBrands: CarBrand[] = [
    ...
    { name: 'HONDA', logo: 'assets/images/vehicle_brand/honda.svg' },
    { name: 'HYUNDAI', logo: 'assets/images/vehicle_brand/hyundai.svg' },
    { name: 'KIA', logo: 'assets/images/vehicle_brand/kia.svg' },
    ...
    { name: 'MITSUBISHI', logo: 'assets/images/vehicle_brand/mitsubishi.svg' },
    { name: 'NISSAN', logo: 'assets/images/vehicle_brand/nissan.svg' },
    { name: 'TOYOTA', logo: 'assets/images/vehicle_brand/toyota.svg' },
  ];
